...
public class usuarioController : ControllerBase
{
    ...
    public async Task<ActionResult> GetUsuario([FromQuery] int id)
    {
        ...
        var usuarioDto = new UsuarioDto(retornoLast.Id, retornoLast.Nome, retornoLast.AvatarUrl, retornoLast.Cpf, retornoLast.Email, retornoLast.Senha, retornoLast.Localizacao.ToString());
    ...
    [HttpPost("altera")]
    public async Task<ActionResult> AlteraUsuario(UsuarioDto usuarioDto)
    {
